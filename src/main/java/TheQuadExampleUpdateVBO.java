...
public class TheQuadExampleUpdateVBO {
   ...
   private void setupShaders() {
      ...
      vsId = this.loadShader("src/main/resources/vertex_textured.glsl", GL20.GL_VERTEX_SHADER);
      // Load the fragment shader
      fsId = this.loadShader("src/main/resources/fragment_textured.glsl", GL20.GL_FRAGMENT_SHADER);
