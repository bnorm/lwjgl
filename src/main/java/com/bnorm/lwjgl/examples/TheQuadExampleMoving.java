...
public class TheQuadExampleMoving {
   ...
   private void setupTextures() {
      try {
         texIds[0] =
                 TextureLoader.getTexture("PNG", ResourceLoader.getResourceAsStream("src/main/resources/stGrid1.png"))
                              .getTextureID();
         texIds[1] =
                 TextureLoader.getTexture("PNG", ResourceLoader.getResourceAsStream("src/main/resources/stGrid2.png"))
                              .getTextureID();
      } catch (IOException e) {
         e.printStackTrace();
      }
   ...
   private void setupShaders() {
      ...
      int vsId = this.loadShader("src/main/resources/vertex_moving.glsl", GL20.GL_VERTEX_SHADER);
      // Load the fragment shader
      int fsId = this.loadShader("src/main/resources/fragment_moving.glsl", GL20.GL_FRAGMENT_SHADER);
